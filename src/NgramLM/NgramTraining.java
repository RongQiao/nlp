...
public class NgramTraining extends NgramTrainingResult{
	public String OUT_FILENAME = "testfiles/LM.txt";
	...
	public NgramTraining(List<String> words, List<String> pairs) {
		this.words = words;
		this.pairs = pairs;
	}

	public NgramTraining() {
