...
public class NgramTest {
	...
	public NgramTest(List<String> pairs, int N) {
		this.pairs = pairs;
		this.N = N;
	}

	public double test(NgramTrainingResult trd) {
		double logProb = 0.0;
...
//		System.out.println(logProb);		
	...
	private List<String> arrangeOutputContent(NgramTrainingResult trd) {
...
//			System.out.println("token:" + sorted_map.size());
	...
	public void outputLanguageModel(NgramTrainingResult trd) {
	...
	private double calculateLogProbPair(String pair, NgramTrainingResult trd) {
		double logProb = 0.0;
		DataMap biMap = trd.getBiMap();
	...
	private double calculateLogProbKatz(String pair, NgramTrainingResult trd) {
